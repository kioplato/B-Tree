 ...
 *  file: main1.c
 *
 *  purpose: Το αρχείο αυτό προσομοιώνει τον ρόλο ενός υψηλότερου-επιπέδου
 *  αρθρώματος ενός ΣΔΒΔ το οποίο καλεί συναρτήσεις του επιπέδου που ασχολείται
 *  με τον χειρισμό b+-δένδρων (ΒΔ). Η προσοχή του αρχείου επικεντρώνεται στην
 *  δημιουργία ΒΔ δένδρων και στην εισαγωγή και αναζήτηση εγγραφών
 ******************************************************************************/
